...
class VentaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ventum" do
    assert_difference('Ventum.count') do
      post venta_url, params: { ventum: { fecha: @ventum.fecha, ticket: @ventum.ticket, total: @ventum.total, usuario_id: @ventum.usuario_id } }
    end
  ...
  test "should update ventum" do
    patch ventum_url(@ventum), params: { ventum: { fecha: @ventum.fecha, ticket: @ventum.ticket, total: @ventum.total, usuario_id: @ventum.usuario_id } }
