...
class VentasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venta" do
    assert_difference('Venta.count') do
      post ventas_url, params: { venta: { fecha: @venta.fecha, ticket: @venta.ticket, total: @venta.total, usuario_id: @venta.usuario_id } }
    end
  ...
  test "should update venta" do
    patch venta_url(@venta), params: { venta: { fecha: @venta.fecha, ticket: @venta.ticket, total: @venta.total, usuario_id: @venta.usuario_id } }
