...
class ProveedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post proveedors_url, params: { proveedor: { celular: @proveedor.celular, descripcion: @proveedor.descripcion, domicilio: @proveedor.domicilio, email: @proveedor.email, negocio_id: @proveedor.negocio_id, nombre: @proveedor.nombre, telefono: @proveedor.telefono } }
    end
  ...
  test "should update proveedor" do
    patch proveedor_url(@proveedor), params: { proveedor: { celular: @proveedor.celular, descripcion: @proveedor.descripcion, domicilio: @proveedor.domicilio, email: @proveedor.email, negocio_id: @proveedor.negocio_id, nombre: @proveedor.nombre, telefono: @proveedor.telefono } }
