...
class GastosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gasto" do
    assert_difference('Gasto.count') do
      post gastos_url, params: { gasto: { categoria_id: @gasto.categoria_id, descripcion: @gasto.descripcion, monto: @gasto.monto, negocio_id: @gasto.negocio_id, usuario_id: @gasto.usuario_id } }
    end
  ...
  test "should update gasto" do
    patch gasto_url(@gasto), params: { gasto: { categoria_id: @gasto.categoria_id, descripcion: @gasto.descripcion, monto: @gasto.monto, negocio_id: @gasto.negocio_id, usuario_id: @gasto.usuario_id } }
